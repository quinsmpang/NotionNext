...
module.exports = {
  ...
  // 已为本站仓库 quinsmpang/NotionNext 开启 Discussions 并配置 General 分类；
  // 仍需在仓库 Settings -> Applications 中安装 giscus app，评论才会正常加载。
  COMMENT_GISCUS_REPO:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'quinsmpang/NotionNext',
  COMMENT_GISCUS_REPO_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOLxlPXQ',
  ...
  COMMENT_GISCUS_CATEGORY_ID:
    ...
    'DIC_kwDOLxlPXc4DBmI2',
  COMMENT_GISCUS_MAPPING:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_MAPPING || 'pathname',
  COMMENT_GISCUS_STRICT: process.env.NEXT_PUBLIC_COMMENT_GISCUS_STRICT || '0',
